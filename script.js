...
let miutes = document.querySelector("#minutes");
let sconds = document.querySelector("#seconds");
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if ('webkitSpeechRecognition' in window) {
      ...
      recognition.onresult = function(event) {
        ...
        const trimmedTranscript = transcript.trim().replace(/\.$/, ''); // Remove trailing period
        inputField.value = trimmedTranscript;
      };
  
      // Start/stop speech recognition on voice button click
      ...
      voiceBtn.style.display = 'none'; // Hide the voice button if not supported
    }
  });
